...
public abstract class UniqueKeys {
    ...
    public static int[] forItem(final Item item) {
        ...
        if(data.getId() != 0 && data.getName() != null) {
            return new int[] {
                Arrays.hashCode(new Object[] {Item.class.getCanonicalName(), item.getPlatform().toString(), item.getVersion(),
                    item.getLocale(), item.getId(), item.getIncludedData()}),
                Arrays.hashCode(new Object[] {Item.class.getCanonicalName(), item.getPlatform().toString(), item.getVersion(),
                    item.getLocale(), item.getName(), item.getIncludedData()})
            };
    ...
    public static int forItemQuery(final Map<String, Object> query) {
        final Integer id = (Integer)query.get("id");
        final String name = (String)query.get("name");
        return Arrays.hashCode(new Object[] {Item.class.getCanonicalName(), ((Platform)query.get("platform")).toString(), (String)query.get("version"),
            (String)query.get("locale"),
            id == null ? name : id.intValue(), (Set<String>)query.get("includedData")});
    }
    ...
    public static int forLanguageStringsQuery(final Map<String, Object> query) {
        return Arrays.hashCode(
            new Object[] {LanguageStrings.class.getCanonicalName(), ((Platform)query.get("platform")).toString(), (String)query.get("version"),
                (String)query.get("locale")});
    }
}
