...
public class ProfileIconData extends DataObject {
    private static final long serialVersionUID = 3669629046479493941L;
     ...
     *        the data to set
     */
    public void setData(final Map<String, ProfileIconDetails> data) {
        this.data = data;
    }
